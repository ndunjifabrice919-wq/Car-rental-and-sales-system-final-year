...
const CACHE_KEY = "driveeasy-vehicles-sale";
// Only the columns the sales cards actually use
const VEHICLE_COLUMNS = "id,make,model,year,type,status,sale_price,image_url,fuel_type,transmission,color,seats,mileage,description,location,created_at";
