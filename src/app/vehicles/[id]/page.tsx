    ...
    <div style={{
      ...
      {pricing && pricing.days > 0 && (
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.82rem", color: "var(--white-muted)", marginBottom: "8px" }}>
            <span>{formatFCFA(vehicle.daily_rate)} × {pricing.days} day{pricing.days > 1 ? "s" : ""}</span>
            <span>{formatFCFA(pricing.originalTotal)}</span>
          </div>
          {pricing.factors.map((f, i) => (
            <div key={i} style={{ display: "flex", justifyContent: "space-between", fontSize: "0.79rem", marginBottom: "5px" }}>
          ...
          <div style={{
            borderTop: "1px solid var(--navy-border)", paddingTop: "12px",
            marginTop: "8px", display: "flex", justifyContent: "space-between", alignItems: "center",
          }}>
            <div>
              <p style={{ fontSize: "0.72rem", color: "var(--white-muted)", margin: "0 0 2px" }}>
                Total · {pricing.days} day{pricing.days > 1 ? "s" : ""}
              </p>
              <p style={{ fontSize: "1.4rem", fontWeight: 900, color: "var(--red)", margin: 0 }}>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.82rem", color: "var(--white-muted)", marginBottom: "8px" }}>
          ...
          <span style={{ textDecoration: hasPriceChange ? "line-through" : "none" }}>
        ...
        <div style={{
          ...
          <div>
            <p style={{ fontSize: "0.72rem", color: "var(--white-muted)", margin: "0 0 2px", textTransform: "uppercase", letterSpacing: "0.06em" }}>
              Your Price
            </p>
            <p style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "6px" }}>
            ...
            {pricing.demandBadge && (
              <span style={{
                background: pricing.demandBadge === "Great Value" ? "rgba(52,211,153,0.12)"
                  : pricing.demandBadge === "High Demand" ? "rgba(251,191,36,0.12)"
